...
See rules/react/hooks.md <!-- TODO: ../../rules/react/hooks.md 链接待修复 --> for the full ruleset. Highlights:
...
- Run `axe` in component tests (see skills/react-testing <!-- TODO: ../react-testing/SKILL.md 链接待修复 -->)
- Cross-link: skills/accessibility/SKILL.md <!-- TODO: ../accessibility/SKILL.md 链接待修复 --> covers WCAG criteria and pattern libraries
...
- Skills: react-performance <!-- TODO: ../react-performance/SKILL.md 链接待修复 --> for the Vercel-derived performance ruleset, frontend-patterns <!-- TODO: ../frontend-patterns/SKILL.md 链接待修复 --> for cross-framework UI concerns, accessibility <!-- TODO: ../accessibility/SKILL.md 链接待修复 -->, angular-developer <!-- TODO: ../angular-developer/SKILL.md 链接待修复 --> for framework comparison
