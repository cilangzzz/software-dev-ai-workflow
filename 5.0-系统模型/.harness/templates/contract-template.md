...
|------|--------|------|------|-----------|
| 1 | PRD文档 | 产品/PRD/PRD-{module}.md | pending | requirement-analyzer |
| 2 | UserStory | 产品/UserStory/UserStory-{module}.md | pending | user-story-generator |
| 3 | 验收标准 | 产品/AcceptanceCriteria/AC-{module}.md | pending | acceptance-criteria-writer |
| 4 | 系统架构 | 研发/系统架构设计.md | pending | architect |
| 5 | 数据库设计 | 研发/数据库设计/DB-{module}.md | pending | db-designer |
| 6 | API设计 | 研发/API设计/API-{module}.md | pending | api-designer |
| 7 | 详细设计 | 研发/详细设计/Detail-{module}.md | pending | implement |
